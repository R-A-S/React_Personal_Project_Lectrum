...
/******/ 	__webpack_require__.p = "/React_Personal_Project_Lectrum/";
/******/
/******/
...
*/
var aa=__webpack_require__(6),ba=__webpack_require__(1),m=__webpack_require__(141),p=__webpack_require__(5),v=__webpack_require__(8),da=__webpack_require__(142),ea=__webpack_require__(143),fa=__webpack_require__(144),ha=__webpack_require__(7);
...
var _stylesM = _interopRequireDefault(__webpack_require__(153));

var _REST = __webpack_require__(155);

var _instruments = __webpack_require__(11);

var _reactFlipMove = _interopRequireDefault(__webpack_require__(162));

var _Task = _interopRequireDefault(__webpack_require__(163));

var _Checkbox = _interopRequireDefault(__webpack_require__(137));

var _Spinner = _interopRequireDefault(__webpack_require__(171));
...
class Scheduler extends _react.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "_updateTasksFilter", e => {
      const {
        value
      } = e.target;
      this.setState({
    ...
    _defineProperty(this, "_updateNewTaskMessage", e => {
      const {
    ...
    _defineProperty(this, "_fetchTasksAsync", async () => {
      try {
        ...
        this.setState({
          tasks: (0, _instruments.sortTasksByGroup)((await _REST.api.fetchTasks()))
        });
    ...
    _defineProperty(this, "_createTaskAsync", async e => {
      const {
        newTaskMessage
      } = this.state;
      e.preventDefault();
      ...
      if (newTaskMessage !== '') {
        try {
          ...
          const taskApi = await _REST.api.createTask(newTaskMessage);
          this.setState(({
            tasks
          }) => ({
            tasks: (0, _instruments.sortTasksByGroup)([taskApi, ...tasks]),
            newTaskMessage: ''
          }));
    ...
    _defineProperty(this, "_updateTaskAsync", async t => {
      const {
        tasks
      } = this.state;
      ...
      const taskApi = await _REST.api.updateTask(t);
      const indexToReplace = tasks.findIndex(task => task.id === taskApi.id);
      this.setState(prevState => ({
        tasks: (0, _instruments.sortTasksByGroup)(prevState.tasks.map((task, index) => index === indexToReplace ? taskApi : task))
      }));
    ...
    _defineProperty(this, "_completeAllTasksAsync", async () => {
      ...
      if (notCompleted.length !== 0) {
        try {
          ...
          await _REST.api.completeAllTasks(completedTasks);
          this.setState(prevState => ({
  ...
  render() {
    ...
    const tasksJSX = tasks.filter(task => task.message.toLocaleLowerCase().includes(tasksFilter)).map(task => _react.default.createElement(_Task.default, _extends({
      key: task.id
    }, task, {
...
var _stylesM = _interopRequireDefault(__webpack_require__(164));

var _Checkbox = _interopRequireDefault(__webpack_require__(137));

var _Star = _interopRequireDefault(__webpack_require__(168));

var _Edit = _interopRequireDefault(__webpack_require__(169));

var _Remove = _interopRequireDefault(__webpack_require__(170));
...
class Task extends _react.PureComponent {
  ...
  render() {
    ...
    return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement("li", {
      className: _stylesM.default.task
...
/***/ })
/******/ ]);
//# sourceMappingURL=source.20545.js.map